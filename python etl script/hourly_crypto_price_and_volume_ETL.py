...
table_id = 'crypto_historical_ohlcv_data_bronze_continuous_load_raw'
client = bigquery.Client(project=project_id)

# API base link
api_link = 'https://data-api.coindesk.com/spot/v1/historical/hours'

# Markets
non_binance_markets = ['coinbase', 'bybit', 'upbit', 'okex']
